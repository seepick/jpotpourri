...
class PtArgumentWrapper {
	...
	public String toString() {
		return "PtArgumentWrapper[hashValue=" + this.hashValue + "; " +
	...
	public boolean equals(final Object other) {
		...
		for (int i = 0; i < this.args.length; i++) {
			...
			if(thisArg == null && thatArg != null ||
			   thisArg != null && thatArg == null) {
				return false;
			...
			} else if(thisArg.getClass().isArray()) { // true, because classes are same ... thatArg.getClass().isArray()
